...
export function SystemCard() {
  ...
  if (blackHole) {
    ...
    const content = getLocalizedPanelContent(blackHole.id, locale, {
      description: blackHole.description,
      tagline: blackHole.tagline,
  ...
  const content = getLocalizedPanelContent(system.id, locale, {
  ...
  return (
    <div className="info-panel system-card open">
      ...
      <span className="tag">{content.tagline ?? system.tagline}</span>
      <h2>{sysName}</h2>
